...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, parker, sdf.parse("21/03/2022"), "Let's go trip", "I'm going to Washington. bye!");
		Post p2 = new Post(null, parker, sdf.parse("23/03/2022"), "Good morning", "I woke up happy today!");
